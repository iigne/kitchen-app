...
public class QuantityMapper {
    ...
    public static QuantityDTO toDTO(int metricQuantity, MetricUnit metricUnit) {
    ...
    public static QuantityDTO toDTO(int metricQuantity, Measurement customUnit) {
        return QuantityDTO.builder()
                .measurementId(customUnit.getId())
                .quantity(metricQuantity/customUnit.getMetricQuantity())
